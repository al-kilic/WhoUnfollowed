...
const faqItems = [
  ...
  { q: 'Is WhoUnfollowed open source?', a: 'The core parser (packages/core) is MIT-licensed and public on GitHub. You can read exactly what happens to your data. The web app is AGPL-3.0 — anyone can self-host it, but Pro features (snapshot history across devices, email alerts, trend charts) require the cloud service because they depend on server infrastructure.' },
